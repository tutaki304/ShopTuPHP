...
<head>
    ...
    <title>Thêm danh mục - ShopTu Admin</title>
...
<body>
    <div class="container">
        ...
        <div class="form-header">
            ...
            <p>Tạo danh mục sản phẩm cho cửa hàng</p>
        </div>
            ...
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="soluongsp" name="soluongsp" class="form-input" 
                           placeholder="Nhập số lượng sản phẩm" min="0" value="0">
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="thutu" name="thutu" class="form-input" 
                           placeholder="Nhập thứ tự" min="1" value="1">
